...
class MOATBlock(nn.Module):
    def __init__(self,
        ...
        # self.partition_function = window_partition()
        # self.reverse_function = window_reverse()
...
if __name__ == '__main__':
    network = moat_2(use_window=True, num_classes=3, window_size=(5, 5))
    input = torch.rand(1, 3, 640, 640)
    # input = torch.rand(1, 3, 224, 224)
    output = network(input)
    print(output.shape)
    # MOATBlock(in_channels=256,out_channels=256,img_size=(256,256),window_size=(5, 5),partition_function=window_partition,reverse_function=window_reverse)
